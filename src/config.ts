...
export const siteConfig: SiteConfig = {
	...
	navbarTitle: {
		...
		icon: "assets/home/maple1.png",
		// 网站Logo图片路径
		logo: "assets/home/maple1.png",
	},
	...
	bangumi: {
		userId: "1243555", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
		fetchOnDev: false, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
	},

	bilibili: {
		vmid: "3017899", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		src: {
			desktop: "/assets/home/kame-house-dragon-ball.jpg", // 桌面横幅图片
			mobile: "/assets/home/kame-house-dragon-ball.jpg", // 移动横幅图片
		}, // 使用本地横幅图片
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "欢迎来到博客，这里会分享生活、兴趣和一些记录。", // 公告内容
